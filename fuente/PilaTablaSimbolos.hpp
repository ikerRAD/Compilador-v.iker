...
private :
	...
	/* Elemento de la pila. Este elemento tiene dos componentes, la tabla de símbolos y la referencia
...
public:
	...
	/* Introduce una nueva tabla de símbolos en la pila, siendo su referencia de ámbito superior
